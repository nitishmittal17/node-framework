...
export { ComponentDefinitionPostProcessor, IComponentDefinitionPostProcessor } from "./lib/processors/ComponentDefinitionPostProcessor";
...
export { ApplicationContextError, ComponentInitializationError, ComponentWiringError, PostConstructionError, PreDestructionError, PostProcessError } from "./lib/errors/ApplicationContextErrors";
...
export { AspectError, AfterAdviceError, AfterReturningAdviceError, BeforeAdviceError, AfterThrowingAdviceError } from "./lib/errors/AspectErrors";
